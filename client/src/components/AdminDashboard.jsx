...
const AdminDashboard = () => {
  ...
  const averageCGPA =
    students.length > 0
      ? (
          students.reduce((acc, curr) => acc + curr.cgpa, 0) / students.length
        ).toFixed(2)
      : 0;
  ...
  return (
    <div className="min-h-screen bg-slate-50 pt-24 px-4 md:px-12">
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-10">
        ...
        <Link
          to="/admin/upload"
          className="bg-indigo-600 hover:bg-indigo-700 text-white p-6 rounded-xl shadow-lg flex items-center justify-center gap-3 transition-transform hover:scale-105"
        >
          <Plus size={24} />
